                            ...
                            <div data-uk-slider>
                                <div class="uk-position-relative" tabindex="-1">
                                    <ul class="uk-slider-items uk-child-width-1-1">
                                        <li><img src="assets/img/img-product-full.png" alt="img-product-full"></li>
                                        <li><img src="assets/img/img-product-full.png" alt="img-product-full"></li>
                                        <li><img src="assets/img/img-product-full.png" alt="img-product-full"></li>
                                        ...
                                        <li>
                                            <div class="product-card">
                                                <div class="product-card__box">
                                                    ...
                                                    <div class="product-card__info">
                                                        <div class="product-card__title"> <a href="{{url("view/03_product")}}">Anti-Aging Cream</a><span>Makeup</span></div>
                                        ...
                                        <li>
                                            <div class="product-card">
                                                <div class="product-card__box">
                                                    ...
                                                    <div class="product-card__info">
                                                        <div class="product-card__title"> <a href="{{url("view/03_product")}}">Hair Style Gel</a><span>Hair Care</span></div>
