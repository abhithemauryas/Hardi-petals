...
<body class="page-blog">
    ...
    <div class="page-wrapper">
        <header class="page-header page-header--static page-header-style-bg">
            <div class="page-header__inner">
                <div class="page-header__logo"><a class="logo" href="index.html"><img src="assets/img/logo-dark.png" alt="Viasun"></a></div>
                <div class="page-header__menu">
                    <nav class="page-nav" data-uk-navbar="">
                        <nav class="page-nav" data-uk-navbar="">
                            <ul class="uk-navbar-nav">
                                <li><a href="{{ url('/') }}">Home</a></li>
                                <li><a href="02{{ route('_shop') }}">Shop</a>
                                    <div class="uk-navbar-dropdown">
                                        <ul class="uk-nav uk-navbar-dropdown-nav">
                                            <li><a href="02{{ route('_shop') }}">Creative Shop Style</a></li>
                                            ...
                                            <li><a href="{{url("view/03_product")}}">Creative Product Page</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li><a href="12_about.html">About</a></li>
                                <li><a href="{{url("view/03_product")}}">Pages</a>
                                    <div class="uk-navbar-dropdown">
                                        <ul class="uk-nav uk-navbar-dropdown-nav">
                ...
                <div class="page-header__btn">
                    <div class="page-header__btns-shop"><a class="uk-button-icon uk-visible@s" href="#modal-search" data-uk-toggle data-uk-icon="search"></a><a class="uk-button-icon" href="#!" data-uk-icon="user"></a><a class="uk-button-icon uk-visible@s" href="#!" data-uk-icon="heart"></a>
                        <div class="uk-inline"><a class="uk-button-icon" href="#!" data-uk-icon="cart"></a>
                            <div data-uk-drop="pos: bottom-right">
                                <div class="uk-card uk-card-body uk-card-default uk-card-small">
                                    <ul class="uk-list uk-list-divider">
                                        <li>
                                            <div class="uk-grid-small uk-flex-middle" data-uk-grid>
                                                <div class="uk-width-auto"><img class="uk-border-circle" width="60" height="60" src="assets/img/product-category-1.png" alt="img"></div>
                                                <div class="uk-width-expand">
                                                    <h5 class="uk-margin-remove-bottom">Perfect Cream</h5>
                                                    <p class="uk-text-meta uk-margin-remove-top">2x $25.00</p>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="uk-grid-small uk-flex-middle" data-uk-grid>
                                                <div class="uk-width-auto"><img class="uk-border-circle" width="60" height="60" src="assets/img/product-category-2.png" alt="img"></div>
                                                <div class="uk-width-expand">
                                                    <h5 class="uk-margin-remove-bottom">V-Beauty Pack</h5>
                                                    <p class="uk-text-meta uk-margin-remove-top">1x $45.00</p>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="uk-grid-small uk-flex-middle uk-flex-between" data-uk-grid>
                                                ...
                                                <div> <span>$95.00</span></div>
                                                <div class="uk-width-1-2"><a class="uk-button uk-button-default uk-button-small uk-width-1-1" href="#!">View cart </a></div>
                                                <div class="uk-width-1-2"><a class="uk-button uk-button-danger uk-button-small uk-width-1-1" href="#!">Checkout</a></div>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    </div><a class="menu-btn" href="#offcanvas" data-uk-toggle> <img src="assets/img/icon_menu-btn-dark.svg" alt="menu-btn"></a>
                </div>
            </div>
        </header>
                ...
                <div class="uk-section uk-margin-large-bottom uk-container">
                    <div class="uk-grid" data-uk-grid>
                        <div class="uk-width-2-3@m">
                            <article class="article-full"><img class="uk-width-1-1" src="assets/img/img-article-full.jpg" alt="">
                                ...
                                <div class="article-full__content">
                                    ...
                                    <div class="uk-grid uk-grid-medium uk-child-width-1-2@s uk-margin-medium" data-uk-grid data-uk-lightbox>
                                        <div><a href="./assets/img/img-article-gallery-1.jpg"><img class="uk-width-1-1" src="./assets/img/img-article-gallery-1.jpg" alt="gallery"></a></div>
                                        <div><a href="./assets/img/img-article-gallery-2.jpg"><img class="uk-width-1-1" src="./assets/img/img-article-gallery-2.jpg" alt="gallery"></a></div>
                                    </div>
                                ...
                                <div class="section-article-navigation">
                                    <div class="article-navigation-item article-navigation-item--prev">
                                        <div class="article-navigation-item__media"> <a href="05_blog-post.html"> <img src="assets/img/news-card-1.jpg" alt="news-card"></a></div>
                                    ...
                                    <div class="article-navigation-item article-navigation-item--next">
                                        <div class="article-navigation-item__media"> <a href="05_blog-post.html"> <img src="assets/img/news-card-2.jpg" alt="news-card"></a></div>
                                        <div class="article-navigation-item__desc">
                            ...
                            <aside class="sidebar">
                                ...
                                <div class="widjet widjet-list-articles">
                                    ...
                                    <ul class="list-articles">
                                        ...
                                        <li class="list-articles-item"><a class="list-articles-item__link" href="05_blog-post.html">
                                                <div class="list-articles-item__img"><img src="./assets/img/img-article-thumb-4.jpg" alt="article-thumb"></div>
                                                <div class="list-articles-item__info">
                                    ...
                                    <div class="product-card">
                                        <div class="product-card__box">
                                            ...
                                            <div class="product-card__info">
                                                <div class="product-card__title"> <a href="{{url("view/03_product")}}">V-Beauty Pack</a><span>Face Lotion</span></div>
        ...
        <footer class="page-footer">
            <div class="page-footer__inner">
                <div data-uk-grid>
                    <div class="uk-width-2-5@m">
                        <div class="page-footer__logo"><a class="logo" href="{{ url('/') }}"><img src="assets/img/logo-big.png" alt="Viasun"></a></div>
                            ...
                            <div class="uk-child-width-1-2" data-uk-grid>
                                <div>
                                    ...
                                    <ul class="uk-nav">
                                        ...
                                        <li> <a href="/{{url("view/03_product")}}"> Our Products</a></li>
                    ...
                    <div class="uk-width-3-5@m">
                        ...
                        <div class="page-footer__bottom">
                            <div class="copy">(c) 2022 — All rights reserved.</div>
            ...
            <div id="offcanvas" data-uk-offcanvas="overlay: true; mode: slide; flip: true">
                <div class="uk-offcanvas-bar uk-flex uk-flex-column uk-flex-between"><button class="uk-offcanvas-close" type="button" data-uk-close=""></button>
                    <div>
                        <div class="uk-margin uk-margin-remove-top"><a class="logo" href="{{ url('/') }}"><img src="assets/img/logo.png" alt="Viasun"></a></div>
                    </div>
                    <div>
                        <div class="uk-margin">
                                ...
                                <li><a href="02{{ route('_shop') }}">Shop</a>
                                    <div class="uk-navbar-dropdown">
                                        <ul class="uk-nav uk-navbar-dropdown-nav">
                                            ...
                                            <li><a href="{{url("view/03_product")}}">Default Product Page</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li><a href="{{url("view/03_product")}}">Collections</a></li>
                                <li><a href="12_about.html">About</a></li>
                                <li><a href="04_blog-main.html">Blog</a>
                                    <div class="uk-navbar-dropdown">
                                        <ul class="uk-nav uk-navbar-dropdown-nav">
                                            ...
                                            <li class="uk-active"><a href="11_blog-post-new.html">Blog post new</a></li>
                                        </ul>
                                    </div>
                                </li>
                                <li><a href="06_contact.html">Contact</a></li>
