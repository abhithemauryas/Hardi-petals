...
<main class="page-main">
            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                     ...
                     <div class="swiper-slide">
                        <div class="section-slider-item section-slider-item-png"><img src="{{asset('img/slider-slide-one.jpeg')}}"
                                alt="slider-slide">
                             <div class="slider-text">“Beauty that’s kind — because compassion never goes out of style.”</div>
                            </div>
                    </div>
                    <div class="swiper-slide">
                     ...
                     <div class="swiper-slide">
                        <div class="section-slider-item section-slider-item-png"><img src="{{asset('img/slider-slide-two.jpeg')}}"
                                alt="slider-slide">
                             <div class="slider-text">“Nurture your glow, just like nature nurtures life.”</div></div>
                    </div>
                    <div class="swiper-slide">
                     ...
                     <div class="swiper-slide">
                        <div class="section-slider-item section-slider-item-png"><img src="{{asset('img/slider-slide-three.jpeg')}}"
                                alt="slider-slide"> <div class="slider-text">“Pure. Gentle. Inspired by nature’s calm essence.”</div></div>
                    </div>
                    <div class="swiper-slide">
                     ...
                     <div class="swiper-slide">
                        <div class="section-slider-item section-slider-item-png"><img src="{{asset('img/slider-slide-four.jpeg')}}"
                                alt="slider-slide"> <div class="slider-text">“Every box holds a promise — pure, kind, and natural.”</div></div>
                    </div>
                ...
                <div>
                    <div class="section-about__desc"
                        ...
                        <div class="section-content">
                            ...
                            <a class="uk-button" href="{{ route('_shop') }}"
                    ...
                    <div class="uk-grid uk-child-width-1-3@m uk-child-width-1-2@s" data-uk-grid
                        ...
                        <div>
                            <div class="product-card">
                                <div class="product-card__box">
                                    <div class="product-card__media"> <img class="product-card__img"
                                            src="/img/img-product-1.jpeg" alt="V-Beauty Pack" />
                                        <div class="product-card__btns">
                                            <ul>
                                                <li><a href="#"><span>Add to cart</span><i
                                                            class="fas fa-shopping-basket"></i></a></li>
                                                <li><a href="#"><span>zoom</span><i class="fas fa-search-plus"></i></a>
                                                </li>
                                    ...
                                    <div class="product-card__info">
                                        <div class="product-card__title"> <a href="{{url("view/03_product")}}">Hair shampoo
                                                </a><span>Hair care</span></div>
                        ...
                        <div>
                            <div class="product-card">
                                <div class="product-card__box">
                                    <div class="product-card__media"> <img class="product-card__img"
                                            src="/img/img-product-2.jpeg" alt="Anti-Aging Cream" />
                                    ...
                                    <div class="product-card__info">
                                        <div class="product-card__title"> <a href="{{url("view/03_product")}}">Conditioner
                                                </a><span>Hair care</span></div>
                        ...
                        <div>
                            <div class="product-card">
                                <div class="product-card__box">
                                    <div class="product-card__media"> <img class="product-card__img"
                                            src="/img/img-product-3.jpeg" alt="Hair Style Gel" />
                                        <div class="product-card__btns">
                                            <ul>
                                                <li><a href="#"><span>Add to cart</span><i
                                                            class="fas fa-shopping-basket"></i></a></li>
                                    ...
                                    <div class="product-card__info">
                                        <div class="product-card__title"> <a href="{{url("view/03_product")}}">Hair Mask
                                                </a><span>Hair Care</span></div>
                                        <div class="product-card__price">€ 22.25</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="product-card">
                                <div class="product-card__box">
                                    <div class="product-card__media"> <img class="product-card__img"
                                            src="/img/img-product-4.jpeg" alt="V-Bath Saltish" />
                                        <div class="product-card__btns">
                                            <ul>
                                                <li><a href="#"><span>Add to cart</span><i
                                                            class="fas fa-shopping-basket"></i></a></li>
                                    ...
                                    <div class="product-card__info">
                                        <div class="product-card__title"> <a href="{{url("view/03_product")}}">Hair Oil & Mask
                                                </a><span>Hair Care</span></div>
                        ...
                        <div>
                            <div class="product-card">
                                <div class="product-card__box">
                                    <div class="product-card__media"> <img class="product-card__img"
                                            src="img/img-product-5.jpeg" alt="Beauty Glow Serum" />
                                        <div class="product-card__btns">
                                            <ul>
                                                <li><a href="#"><span>Add to cart</span><i
                                                            class="fas fa-shopping-basket"></i></a></li>
                                    ...
                                    <div class="product-card__info">
                                        <div class="product-card__title"> <a href="{{url("view/03_product")}}">Hair Conditioner
                                                </a><span>Hair Care</span></div>
                                        <div class="product-card__price">€ 19.00</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="product-card">
                                <div class="product-card__box">
                                    <div class="product-card__media"> <img class="product-card__img"
                                            src="/img/img-product-6.jpg" alt="Skinny Lotion" />
                                        <div class="product-card__btns">
                                            <ul>
                                                <li><a href="#"><span>Add to cart</span><i
                                                            class="fas fa-shopping-basket"></i></a></li>
                                    ...
                                    <div class="product-card__info">
                                        <div class="product-card__title"> <a href="{{url("view/03_product")}}">Hair Oil
                                                </a><span>Hair Care</span></div>
 ...
 <div class="section-video">
    <div class="section-video__bg" data-uk-lightbox>
        <a class="section-video__link"
           href="https://youtu.be/IUYs3mYgEPI"
   ...
   <div class="section-info">
            ...
            <div>
                <div class="section-info__desc"
                    ...
                    <div class="section-content">
                        ...
                        <a class="uk-button uk-button-danger uk-button-large" href="{{ route('_shop') }}">
                            Discover More
                        </a>
                    </div>
                </div>
        ...
        <div class="uk-grid uk-grid-collapse uk-child-width-1-2@l" data-uk-grid>
            <div>
                <div class="section-newsletter__form"
                    data-uk-scrollspy="target: > *; cls: uk-animation-slide-bottom-small; delay: 300">
                    <div class="section-newsletter__title"> <span style="color: #D4AF37;">Naturally Inspired Wellness</span>
                    ...
                    <form action="#!">
                        ...
                        <!-- END Hidden Required Fields --><input type="text" placeholder="youremail@example.com"><input
                            class="uk-button uk-button-danger" type="submit" value="Subscribe now">
                    </form>
                </div>
            </div>
            <div>
    ...
    <div class="section-instagram">
        <div class="uk-section uk-container uk-container-large">
            <div class="section-title"
                data-uk-scrollspy="target: > *; cls: uk-animation-slide-bottom-small; delay: 300"><span>Follw our
                    gallery</span>
                    <!-- https://www.instagram.com/hardi_petals/ -->
                ...
                <div class="uk-grid uk-grid-small uk-flex-middle" data-uk-grid>
                    <div class="uk-width-1-4@m uk-width-1-2">
                        <div class="instagram-item instagram-item-1"
                            data-uk-scrollspy="cls:uk-animation-slide-left-small"><img src="img/instagram-1.jpg"
                                alt="instagram"></div>
                        <div class="instagram-item instagram-item-2"
                            data-uk-scrollspy="cls:uk-animation-slide-left-small; delay: 200"><img
                                src="img/instagram-2.jpg" alt="instagram"></div>
                    </div>
                    <div class="uk-width-1-4@m uk-width-1-2 uk-flex-last@m">
                        <div class="instagram-item instagram-item-4"
                            ...
                            <img
                                src="img/instagram-4.jpg" alt="instagram">
                            </div>
                        <div class="instagram-item instagram-item-5"
                            data-uk-scrollspy="cls:uk-animation-slide-right-small; delay: 800"><img
                                src="img/instagram-5.jpg" alt="instagram"></div>
                    </div>
                    <div class="uk-width-expand@m">
                        <div class="instagram-item instagram-item-3"
                            data-uk-scrollspy="cls:uk-animation-fade; delay: 400"><img src="img/instagram-3.jpg"
                                alt="instagram"></div>
                    </div>
                </div>
            </div>
    ...
    <div class="section-new-arrivals section-news-and-posts">
        <div class="uk-background-muted">
            <div class="uk-section-large uk-container">
                <div class="section-title"
                    data-uk-scrollspy="target: > *; cls: uk-animation-slide-bottom-small; delay: 300"><span>Hardi Petals
            ...
            <ul class="uk-slider-items uk-grid uk-child-width-1-2@s uk-child-width-1-3@m uk-child-width-1-4@l">
                ...
                <li>
                    <div class="news-card">
                        <div class="news-card__media">
                            <a href="{{ route('blog') }}">
                                <img src="{{ asset('img/news-card-1.jpg') }}" alt="Daily Self-Care Rituals">
                            </a>
                        </div>
                ...
                <li>
                    <div class="news-card">
                        <div class="news-card__media">
                            <a href="{{ route('blog') }}">
                                <img src="{{ asset('img/news-card-2.jpg') }}" alt="Benefits of Nature Therapy">
                            </a>
                        </div>
                        <div class="news-card__body">
                            <div class="news-card__info">
                ...
                <li>
                    <div class="news-card">
                        <div class="news-card__media">
                            <a href="{{ route('blog') }}">
                                <img src="{{ asset('img/news-card-3.jpg') }}" alt="Holistic Wellness Tips">
                            </a>
                        </div>
                        <div class="news-card__body">
                            <div class="news-card__info">
                ...
                <li>
                    <div class="news-card">
                        <div class="news-card__media">
                            <a href="{{ route('blog') }}">
                                <img src="{{ asset('img/news-card-4.jpg') }}" alt="Reconnect with Your Inner Self">
                            </a>
                        </div>
                        <div class="news-card__body">
                            <div class="news-card__info">
