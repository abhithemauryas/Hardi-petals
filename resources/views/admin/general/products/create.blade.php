            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <select class="form-control" name="product_category" id="product-categories" required data-choices
                            data-choices-groups data-placeholder="Select Categories" name="choices-single-groups">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="mb-3">
                            ...
                            <input type="number" name="stock" id="product-stock" class="form-control" value="10"
                                required>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number" name="discount" id="product-discount" class="form-control"
                                placeholder="000">
                        </div>
                    </div>
                </div>
            ...
            $('#dropzone-preview-list').append('<div class="mt-2 col-4" data-index="' + index + '">\
                        <div class="d-flex p-2 border rounded">\
                            ...
                            <div class="flex-shrink-0 ms-3">\
                                <button data-dz-remove class="btn btn-sm btn-primary" onclick="removeSpecificFile(' +
                index + ')">Delete</button>\
                            </div>\
                        </div>\
                    </div>')
