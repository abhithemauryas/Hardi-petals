@extends('admin.layouts.vertical', ['title' => 'Roles List'])
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                ...
                                <a href="{{ route('admin.third', ['users', 'role', 'edit'])}}" class="btn btn-soft-primary btn-sm"><iconify-icon icon="solar:pen-2-broken" class="align-middle fs-18"></iconify-icon></a>
