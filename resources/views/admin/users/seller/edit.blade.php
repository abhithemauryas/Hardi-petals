@extends('admin.layouts.vertical', ['title' => 'Seller Edit'])
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap justify-content-between my-3">
                        <div>
                            <h4 class="mb-1">ZARA International<span class="text-muted fs-13 ms-1">(Fashion) </span>
                            </h4>
                            <div>
                        ...
                        <div>
                            <p class="mb-0"><span class="badge bg-light text-dark fs-12 me-1"><i
                                        class="bx bxs-star align-text-top fs-14 text-warning me-1"></i> 4.5</span>3.5k
                            </p>
                        </div>
                    </div>
                    <div class="">
                    ...
                    <div class="d-flex align-items-center justify-content-between mt-3 mb-1">
                        ...
                        <div>
                            <p class="mb-0 fs-15 fw-medium text-dark">$200k <span class="ms-1"><iconify-icon
                                        icon="solar:course-up-outline" class="text-success"></iconify-icon></span></p>
                        </div>
                    </div>
                    <div class="progress progress-soft progress-md">
                        <div class="progress-bar bg-danger progress-bar-striped progress-bar-animated"
                             role="progressbar" style="width: 80%" aria-valuenow="" aria-valuemin="0"
                            ...
                            <form>
                                ...
                                <div class="input-group mb-3">
                                    <span class="input-group-text fs-20"><iconify-icon
                                            icon="solar:point-on-map-bold-duotone" class="fs-18"></iconify-icon></span>
                                    <input type="text" id="seller-location" class="form-control"
                                           placeholder="Add Address" value="4604 , Philli Lane Kiowa IN 47404">
                                </div>
                            </form>
                        </div>
                        <div class="col-lg-6">
                            <form>
                                ...
                                <div class="input-group mb-3">
                                    <span class="input-group-text fs-20"><iconify-icon icon="solar:letter-bold-duotone"
                                                                                       class="fs-18"></iconify-icon></span>
                                    <input type="email" id="seller-email" class="form-control" placeholder="Add Email"
                                           value="zarafashionworld@dayrep.com">
                                </div>
                            </form>
                        </div>
                        <div class="col-lg-6">
                            <form>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="seller-number" class="form-control"
                                           placeholder="Phone number" value="+243 812-801-9335">
                                </div>
                            </form>
                        </div>
                        <div class="col-lg-12">
                            ...
                            <div class="formCost d-flex gap-2 align-items-center mt-2">
                                <input class="form-control form-control-sm text-center w-50" type="text" id="maxCost"
                                       value="$200">
                            </div>
                        </div>
                    </div>
